	...
	<div class="content-box">
		...
		<div class="content-box-content">
			<div class="tab-content default-tab">
				<form action="<?php echo U('Admin/adminEdit',array('aid'=>$aid));?>" method="post">
					<fieldset>
						<p>
							<label>管理员名称</label>
							<input class="text-input small-input" type="text" id="small-input" name="account" value="<?php echo ($info["account"]); ?>"/>
						</p>
						<p>
							<label>密码</label>
