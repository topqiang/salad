	...
	<div class="content-box">
		...
		<div class="content-box-header">
			...
			<ul class="content-box-tabs">
				...
				<li><a href="<?php echo U('Goods/goodsAdd');?>" class="default-tab">添加商品</a></li>
			</ul>
			<div class="clear"></div>
		</div>
			...
			<div class="tab-content default-tab">
				<form action="<?php echo U('Goods/goodsAdd');?>" method="post" enctype="multipart/form-data">
					<fieldset>
						...
						<p>
							<label>主要成分</label>
							<input class="text-input small-input" type="text" id="small-input" name="constituent" />
						</p>
						<p>
							<label>分类</label>
							<select name="cate_id">
						...
						<p>
							<label>备注描述</label>
							<input class="text-input small-input" type="text" id="small-input" name="remark" />
						</p>
						<p>
