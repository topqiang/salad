	...
	<div class="content-box">
		...
		<div class="content-box-content">
			<div class="tab-content default-tab">
				<form action="<?php echo U('Msg/msgupd');?>" method="post" onsubmit="return putmsg()" enctype="multipart/form-data">
					<fieldset>
					<input class="text-input small-input" type="hidden" id="id" name="id" value="<?php echo ($msg["id"]); ?>"/>
						<!-- <p>
							<label>开始时间</label>
							<input class="text-input small-input" type="text" id="startime" name="startime" value="<?php echo ($coupon["star_time"]); ?>" />
						</p>
						<p>
							<label>结束时间</label>
							<input class="text-input small-input" type="text" id="endtime" name="endtime" value="<?php echo ($coupon["end_time"]); ?>" />
						</p> -->
						<p>
							<label>内容</label>
							<input class="text-input small-input" type="text" id="msg" name="msg" value="<?php echo ($msg["msg"]); ?>" />
						</p>
						<p>
