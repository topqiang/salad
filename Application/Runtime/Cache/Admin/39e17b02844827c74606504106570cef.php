				...
				<form action="<?php echo U('AdminBasic/delList',array('tname'=>'Admin'));?>" method="post">
					<table border="1">
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<a href="<?php echo U('Admin/adminEdit',array('aid'=>$vo['aid']));?>" title="编辑"><img src="/salad/Public/Admin/images/icons/pencil.png" alt="Edit" /></a>
									<a href="<?php echo U('Admin/adminDel',array('aid'=>$vo['aid']));?>" title="删除"><img src="/salad/Public/Admin/images/icons/cross.png" alt="Delete" /></a>
								</td>
