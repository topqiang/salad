	...
	<div class="content-box">
		...
		<div class="content-box-content">
			<div class="tab-content default-tab">
				<form action="<?php echo U('About/aboutupd');?>" method="post" onsubmit="return putabout()" enctype="multipart/form-data">
					<fieldset>
					<input class="text-input small-input" type="hidden" id="id" name="id" value="<?php echo ($about["id"]); ?>"/>
						...
						<p>
							<label>内容</label>
							<textarea class="text-input small-input" type="text" id="content" name="content" style="min-height:200px"><?php echo ($about["content"]); ?></textarea>
						</p>
						<p>
