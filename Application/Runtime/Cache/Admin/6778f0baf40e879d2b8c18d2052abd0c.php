            ...
            <ul id="main-nav">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo U('Rate/ratelist');?>" target="main">评论管理</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="#" class="nav-top-item">门店管理</a>
                    <ul>
                        <li><a href="<?php echo U('Shop/manapic');?>" target="main">门店轮播</a></li>
                        <li><a href="<?php echo U('Shop/shoplist');?>" target="main">门店列表</a></li>
                        <li><a href="<?php echo U('Msg/index');?>" target="main">通知列表</a></li>
                        <li><a href="<?php echo U('About/aboutupd',array('id'=>1));?>" target="main">关于Happy Daze</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="nav-top-item">业务管理</a>
                    <ul>
                        <li><a href="<?php echo U('Coupon/index');?>" target="main">优惠券列表</a></li>
                        <li><a href="<?php echo U('Luggage/index');?>" target="main">运费管理</a></li>
                    </ul>
                </li>
				<li>
