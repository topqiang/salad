		...
		<?php if(is_array($ordinfo)): $i = 0; $__LIST__ = $ordinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><div class="det-dius-bd">
				<ul class="fl-clr">
					...
					<li class="tec-btn fl-clr">
							<?php if($order['type'] == 0): ?><div class="order-btn-l"><a href="<?php echo U('Order/gopay');?>/oid/<?php echo ($order["oid"]); ?>">确认付款</a>
								...
								<?php elseif($order['type'] == 3): ?><div class="order-btn-l"><a href="<?php echo U('Order/rate');?>/oid/<?php echo ($order["oid"]); ?>">评价</a><?php endif; ?>
						</div>
