...
<body>
    ...
    <div class="cart-bt">
		...
		<?php if($count != 0): ?><ul class="fl-clr" id="Bottom_Button_1">
			<li class="fl-left">
				<a href="<?php echo U('Index/index');?>"><span><font id="_df17_self_pick" style="">再来一份</font></span></a>
			</li>
			<li class="fl-right putorder">
				<span><font id="_df17_go_buy" style="">去下单</font></span>
			</li>
		</ul>
		<a href="<?php echo U('Goods/goodlist',array('cname'=>'鲜榨果汁'));?>" data="javascript:alert('敬请期待');">
