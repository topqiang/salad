...
<style type="text/css">
	...
	<div class="index-top">
        ...
        <div class="index-hd">
			...
			<div id="CartLine"><span class="cart-ico" onclick="H5Method.JUMPUrl(&#39;/df17.html&#39;);"><em><?php echo ($count); ?></em></span></div>
		</div>
	</div>
	...
	<div class="nav">
    	<table>
			<tbody>
				<tr>
					<td class="homeNav nav-1" onclick="H5Method.JUMPUrl(&#39;/df8.html&#39;)">
						<div>
    ...
    <div class="bottom-menu"> 
		<ul class="bt-menu-inner fl-clr">
			<li onclick="H.ShopJump();">
				<span>到店自提</span>
			</li>
			<li onclick="H.AddressJump();">
				<span>送货上门</span>
			</li>
...
$(function(){
	H.GetDefaultAddress();
	H.GetHomeFocusImgList();
	H.GetProductClassList();
});
</script>
