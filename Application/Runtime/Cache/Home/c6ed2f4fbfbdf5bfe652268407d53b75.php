...
<body>
	...
	<div class="con-wrap-bt3">
		...
		<?php if(($_REQUEST['cname'] != '帮选沙拉') && ($_REQUEST['cname'] != '鲜榨果汁')): ?><div class="main-menu menu-pro" id="ClassListLine">
						...
						<table>
							<tbody>
								<tr>
									...
									<td align="right" id="<?php echo ($good["gid"]); ?>" onclick="location.href='<?php echo U('Rate/ratelist');?>/gid/<?php echo ($good["gid"]); ?>'">
										<span class="td-r"><?php echo ($good["ratenum"]); ?></span>
									</td>
								</tr>
							</tbody>
						</table>
				...
				success:function(data){
					...
					if (datajson.length == 0) {
						...
						for(var index in datajson){
							...
							newdom.append('<div class="pro-detail"><dl class="pro-des"><dt><img src="/salad/'+obj.gpic+'" style="height:165px;"></dt><dd><h3>'+obj.gname+'</h3><ul><li class="fl-clr"><em>'+obj.gconstituent+'</em></li></ul></dd><dd class="fl-clr"><span class="td-2">￥<i class="price">'+obj.gprice+'</i>/份</span><div class="td-3 fl-clr"><em class="car-add-l"></em><input type="text" id="'+obj.gid+'" value="0" readonly="" class="inpt-shu"><em class="car-add-r"></em></div></dd></dl><div class="pro-com"><table><tbody><tr><td align="left" id="'+obj.gid+'"><span class="td-l '+((obj.well == 1) ? "on" : "")+'" hid='+(obj.hid ? obj.hid : "")+'>'+obj.wellnum+'</span></td><td align="center" id="'+obj.gid+'"><span class="td-m '+((obj.bad == 1) ? "on" : "")+'" hid='+(obj.hid ? obj.hid : "")+'>'+obj.badnum+'</span></td><td align="right" onclick="location.href=\'<?php echo U('Rate/ratelist');?>/gid/'+obj.gid+'\'"><span class="td-r">'+obj.ratenum+'</span></td></tr></tbody></table></div></div>');
						}
